...
const AdminDashboard = () => {
  ...
  if (!authChecked) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,rgba(244,63,94,0.14),transparent_24%),linear-gradient(180deg,#fff1f2,#fff7ed_40%,#f8fafc)] dark:bg-[radial-gradient(circle_at_top_left,rgba(244,63,94,0.1),transparent_24%),linear-gradient(180deg,#020617,#111827_40%,#0f172a)]">
        <div className="rounded-[28px] border border-white/70 bg-white/85 px-6 py-5 text-sm font-medium text-slate-600 shadow-[0_24px_90px_rgba(15,23,42,0.08)] backdrop-blur dark:border-white/10 dark:bg-slate-900/75 dark:text-slate-300 dark:shadow-[0_24px_90px_rgba(2,6,23,0.45)]">
  ...
  return (
    <div className="relative flex h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(244,63,94,0.14),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(236,72,153,0.14),transparent_22%),linear-gradient(180deg,#fff1f2_0%,#fff7ed_40%,#f8fafc_100%)] text-slate-900 transition-colors duration-300 dark:bg-[radial-gradient(circle_at_top_left,rgba(244,63,94,0.1),transparent_24%),radial-gradient(circle_at_bottom_right,rgba(236,72,153,0.1),transparent_22%),linear-gradient(180deg,#020617_0%,#111827_45%,#0f172a_100%)] dark:text-slate-100">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[-8rem] top-[-6rem] h-72 w-72 rounded-full bg-rose-400/20 blur-3xl" />
        <div className="absolute bottom-[-8rem] right-[-5rem] h-80 w-80 rounded-full bg-fuchsia-400/20 blur-3xl" />
      </div>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex h-screen w-[300px] max-w-[85vw] flex-col border-r border-white/20 bg-white/12 px-4 py-4 text-white shadow-[0_30px_80px_rgba(15,23,42,0.24)] backdrop-blur-2xl transition-transform duration-300 lg:relative lg:h-full lg:w-80 lg:max-w-none lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full lg:w-24 lg:translate-x-0"
        }`}
      >
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(225,29,72,0.95),rgba(239,68,68,0.88),rgba(192,38,211,0.88))]" />
        <div className="relative flex h-full flex-col">
          <div className="flex items-center justify-between gap-3 px-2 pb-5">
            <div className={`overflow-hidden transition-all duration-300 ${sidebarOpen ? "opacity-100" : "opacity-0 lg:w-0"}`}>
              <p className="bg-gradient-to-r from-white via-rose-100 to-fuchsia-100 bg-clip-text text-lg font-black uppercase tracking-[0.42em] text-transparent drop-shadow-[0_4px_18px_rgba(255,255,255,0.26)]">
                HackHunt
              </p>
            </div>
            ...
            <button
              ...
              className={`inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/15 bg-white/10 text-white shadow-lg shadow-rose-950/20 transition duration-300 hover:scale-[1.03] hover:bg-white/20 ${
          ...
          >
            <div className={`flex items-center gap-4 ${sidebarOpen ? "" : "lg:justify-center"}`}>
              <div className="relative">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-rose-300 to-fuchsia-300 blur-sm opacity-90" />
              ...
              return (
                <button
                  ...
                  className={`group relative flex w-full items-center gap-4 overflow-hidden rounded-[22px] px-4 py-3.5 text-left transition-all duration-300 ${
                    isActive
                      ? "bg-white font-semibold text-rose-700 shadow-[0_18px_35px_rgba(255,255,255,0.16)]"
                      : "text-white/88 hover:bg-white/12 hover:text-white"
                  } ${sidebarOpen ? "" : "lg:justify-center lg:px-0"}`}
                >
                  {isActive && <div className="absolute inset-0 rounded-[22px] bg-[radial-gradient(circle_at_left,rgba(244,63,94,0.16),transparent_55%)]" />}
                  <span
                    className={`relative flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl transition-all duration-300 ${
                      isActive
                        ? "bg-gradient-to-br from-rose-100 to-fuchsia-100 text-rose-700 shadow-lg shadow-rose-500/20"
          ...
          <div className="mt-4 rounded-[24px] border border-white/15 bg-white/10 p-3">
            {sidebarOpen ? (
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-rose-500 via-red-500 to-fuchsia-600 px-4 py-3 text-sm font-semibold text-white shadow-[0_18px_35px_rgba(244,63,94,0.35)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_40px_rgba(244,63,94,0.42)]"
              >
                <LogOut size={17} />
                Logout
              </button>
              ...
              <button
                type="button"
                onClick={() => setShowLogoutConfirm(true)}
                className="mx-auto inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-r from-rose-500 to-fuchsia-600 text-white shadow-lg shadow-rose-900/30"
              >
                <LogOut size={17} />
              </button>
            )}
      ...
      <main className="relative z-10 flex-1 overflow-y-auto">
        <div className="mx-auto flex min-h-full max-w-[1600px] flex-col px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
          ...
          <section className="relative overflow-hidden rounded-[32px] border border-white/65 bg-white/72 px-6 py-6 shadow-[0_28px_90px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-colors duration-300 dark:border-white/10 dark:bg-slate-900/65 dark:shadow-[0_28px_90px_rgba(2,6,23,0.45)] sm:px-8 sm:py-8">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(244,63,94,0.18),transparent_24%),linear-gradient(135deg,rgba(255,255,255,0.88),rgba(255,241,242,0.74))] dark:bg-[radial-gradient(circle_at_top_right,rgba(244,63,94,0.12),transparent_24%),linear-gradient(135deg,rgba(30,41,59,0.9),rgba(15,23,42,0.72))]" />
            <div className="relative flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 transition-colors duration-300 dark:text-slate-300 sm:text-base">
                  Welcome back, {user?.name || "Admin"}. Review approvals, manage accounts, and monitor platform operations from the same premium dashboard experience.
                </p>
              </div>
          ...
          <section className="mt-6 flex-1 rounded-[34px] border border-white/65 bg-white/70 p-4 shadow-[0_28px_110px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-colors duration-300 dark:border-white/10 dark:bg-slate-900/60 dark:shadow-[0_28px_110px_rgba(2,6,23,0.5)] sm:p-6 lg:p-8">
            <AdminSectionErrorBoundary>
              ...
              {activeSection === "activity" && <AdminActivityLog />}
            </AdminSectionErrorBoundary>
          </section>
        </div>
      </main>
